...
public class MainActivity extends AppCompatActivity {
    ...
    private static ArrayList<Planet> generatePlanetData(){
        ...
        planet.setUkuranPlanet(6.9911f);
        ...
        planet.setUkuranPlanet(5.8232f);
        ...
        planet.setUkuranPlanet(2.5362f);
        ...
        planet.setUkuranPlanet(2.4622f);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Daftar Nama Planet");
        }
